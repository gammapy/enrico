...
TAG_ISO = "V2_v1"
DIFFUSE_ISO_SOURCE = 'iso_P8R3_SOURCE_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEPSF0 = 'iso_P8R3_SOURCE_PSF0_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEPSF1 = 'iso_P8R3_SOURCE_PSF1_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEPSF2 = 'iso_P8R3_SOURCE_PSF2_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEPSF3 = 'iso_P8R3_SOURCE_PSF3_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEEDISP0 = 'iso_P8R3_SOURCE_EDISP0_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEEDISP1 = 'iso_P8R3_SOURCE_EDISP1_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEEDISP2 = 'iso_P8R3_SOURCE_EDISP2_'+TAG_ISO+'.txt'
DIFFUSE_ISO_SOURCEEDISP3 = 'iso_P8R3_SOURCE_EDISP3_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEAN = 'iso_P8R3_CLEAN_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANPSF0 = 'iso_P8R3_CLEAN_PSF0_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANPSF1 = 'iso_P8R3_CLEAN_PSF1_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANPSF2 = 'iso_P8R3_CLEAN_PSF2_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANPSF3 = 'iso_P8R3_CLEAN_PSF3_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANEDISP0 = 'iso_P8R3_CLEAN_EDISP0_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANEDISP1 = 'iso_P8R3_CLEAN_EDISP1_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANEDISP2 = 'iso_P8R3_CLEAN_EDISP2_'+TAG_ISO+'.txt'
DIFFUSE_ISO_CLEANEDISP3 = 'iso_P8R3_CLEAN_EDISP3_'+TAG_ISO+'.txt'
